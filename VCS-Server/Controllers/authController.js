...
class AuthController{
    ...
    static async devSignupHandler(req, res, next){
        try{
    ...
    static async devLoginHandler(req, res, next){
        try{
            const {devname, password} = req.body;
            const hashedPassword = getHash(process.env.HASH_SECRET_VALUE.toString(), password);
    ...
    static async orgSignupHandler(req, res, next){
        try{
    ...
    static async orgLoginHandler(req, res, next){
        try{
            const {orgname, password} = req.body;
            const hashedPassword = getHash(process.env.HASH_SECRET_VALUE.toString(), password);
