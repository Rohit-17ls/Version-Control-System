...
class ProjectController{
    ...
    static async getCommitInsights(req, res, next) {
        try{
            ...
            const formatString = "</details><div class='text-3xl my-8 semibold'>Commit Hash : %H</div><strong style='color:#cfcf00; margin-top: -1vh'>\
%nDate : %ad%nCommit : %s%n</strong><details class='p-2 card-bg rounded-lg min-w-[400px] max-w-[600px]'><summary><strong class='my-3'>\
View Diff</strong><button class='button' style='background : #129f2f' type='button' onclick='askAI()'>Ask AI</button></summary>";
